...
function createStyles(colors: ThemeColors) {
  return StyleSheet.create({
    ...
    exportButton: { backgroundColor: colors.successFill, borderRadius: 10, padding: 12, alignItems: "center" },
    exportButtonText: { color: colors.onPrimary, fontWeight: "700", fontSize: 14 },
    emailButton: { backgroundColor: colors.primaryFill, marginTop: 10 },
